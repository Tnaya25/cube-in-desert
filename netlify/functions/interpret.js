...
Символіка: Пустеля = відчуття свого життєвого простору зараз. Куб = образ себе. Драбина = близькі стосунки. Кінь = партнер або відчуття свободи. Квіти = те що приносить радість і ніжність. Шторм = поточні труднощі або тривога.Символіка (дотримуйся чітко):
...
- Кінь = романтичний партнер або бажаний партнер: його стан, поведінка і відстань = стан цих стосунків або бажань
