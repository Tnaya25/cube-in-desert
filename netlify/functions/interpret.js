...
Напиши відповідь українською, звертаючись до ${name} на "ти" і тільки на ім'я — не використовуй "люба", "дорога" чи будь-які слова що припускають стать. Тон — теплий і щирий, як у мудрого друга, але без сентиментальності і солодкавості. Не закінчуй обіймами чи побажаннями — просто говори по суті. Не аналізуй особистість — відображай поточний стан і настрій. Визнай те що важко, але обов'язково знайди і назви те що сильне і світле в картині. Суцільний живий текст без списків, 3–4 абзаци.`,
